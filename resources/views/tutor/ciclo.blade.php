...
<style>
    ...
    .detalle-k { color: #858796; font-weight: 600; flex: 0 0 auto; white-space: nowrap; }
    .detalle-v { color: #2f3441; text-align: right; word-break: break-word; }
</style>
@endpush
...
<div class="container-fluid docente-ui-page">
    @include('docentes.partials.ui-header', [
        ...
        'subtitle'  => 'Listado de alumnos del ciclo.',
                                    ...
                                    <div class="row">
                                        @foreach ($seccionesDetalle as $seccion)
                                            <div class="col-md-6 col-xl-3 mb-2">
                                                <div class="detalle-card h-100 px-2 py-2">
                                                    <div class="detalle-card-title mb-1">{{ $seccion['titulo'] }}</div>
                                                    @foreach ($seccion['campos'] as $campo)
                                                        <div class="detalle-row">
                                                            <span class="detalle-k">{{ $campo['k'] }}</span>
                                                            <span class="detalle-v">{{ $campo['v'] }}</span>
                                                        </div>
                                                    @endforeach
                                                </div>
                                            </div>

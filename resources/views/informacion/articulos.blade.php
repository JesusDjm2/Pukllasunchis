            ...
            <div class="col-lg-3">
                <div class="pegajoso desktop">
                    ...
                    <ul class="submenu2">
                        ...
                        <li><a href="{{ route('articulos') }}"><i class="fa fa-caret-right fa-sm"></i> Artículos</a></li>
                        <li><a href="{{ route('investigacion') }}"><i class="fa fa-caret-right fa-sm"></i> Proyectos Académicos</a>
                        </li>

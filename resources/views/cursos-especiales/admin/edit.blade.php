...
<div class="container-fluid cea-form-page">
    <div class="cea-form-header">
        <h1><i class="fas fa-edit mr-2" style="color:#f6c23e"></i>Editar Curso</h1>
    </div>
    ...
    <form action="{{ route('ce.cursos.update', $curso) }}" method="POST" enctype="multipart/form-data">
        @csrf @method('PUT')
        @include('cursos-especiales.admin._form')
        <div class="cea-form-footer">
            <button type="submit" class="cea-submit-btn"><i class="fas fa-save"></i> Guardar Cambios</button>

...
@section('titulo', 'Editar Lección — ' . $leccion->nombre)
...
<div class="container-fluid cea-form-page">
    <div class="cea-form-header">
        ...
        <h1><i class="fas fa-edit mr-2" style="color:#f6c23e"></i>Editar Lección</h1>
    </div>
    ...
    <form action="{{ route($rp . '.lecciones.update', [$curso, $nivel, $unidad, $leccion]) }}" method="POST">
        @csrf @method('PUT')

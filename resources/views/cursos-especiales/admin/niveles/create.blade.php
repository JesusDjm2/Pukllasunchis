...
@section('titulo', 'Nuevo Nivel — ' . $curso->nombre)
...
<div class="container-fluid cea-form-page">
    <div class="cea-form-header">
        <h1><i class="fas fa-layer-group mr-2" style="color:#36b9cc"></i>Nuevo Nivel</h1>
    </div>
    <form action="{{ route($rp . '.niveles.store', $curso) }}" method="POST">
        @csrf
        <div class="cea-field-group">
            ...
            <div class="form-group">
                ...
                <input type="text" name="nombre" class="form-control @error('nombre') is-invalid @enderror"
                       value="{{ old('nombre') }}" placeholder="Ej: Nivel Básico — Ñawpaq Yachay" required>

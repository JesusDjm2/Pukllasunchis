...
<div class="container-fluid cea-form-page">
    <div class="cea-form-header">
        <h1><i class="fas fa-edit mr-2" style="color:#f6c23e"></i>Editar Unidad</h1>
    </div>
    <form action="{{ route($rp . '.unidades.update', [$curso, $nivel, $unidad]) }}" method="POST">
        @csrf @method('PUT')
        <div class="cea-field-group">
            ...
            <div class="form-group mb-0">
                ...
                <input type="number" name="orden" class="form-control" style="max-width:120px"
                       min="0" value="{{ old('orden', $unidad->orden) }}">
            </div>
        </div>

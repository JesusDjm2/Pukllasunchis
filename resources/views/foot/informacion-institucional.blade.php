...
@section('contenido')
    ...
    <div class="container pt-5 pb-5">
        <div class="row">
            <div class="col-lg-12">
                <h2 class="linea-debajo">Documentos de Gestión</h2>
                ...
                <div class="row justify-content-center align-items-center fichas mt-4">
                    <div class="col-lg-4 mb-4">
                        <div class="card text-center pt-4">
                            <a href="{{ ASSET('pdf/RM-387-2020-MINEDU-Licenciamiento-22092020 2.pdf') }}" target="_blank">
                                ...
                                <p class="text-center">Resolución de Licenciamiento Vigente</p>
                                <p class="text-center"><i class="fa fa-arrow-circle-right fa-lg"></i></p>
                            </a>
                        </div>
                    </div>
                    <div class="col-lg-4 mb-4">
                        <div class="card text-center pt-4">
                            <a href="{{ asset('pdf/Conformacion-del-cuerpo docente-Directivos-y-Docentes.pdf') }}"
                                target="_blank">
                                <div style="height: 100px">
                    ...
                    <div class="col-lg-4 mb-4">
                        <div class="card text-center pt-4">
                            <a href="{{ asset('pdf/Relacion-de-Becarios-EESP-Pukllasunchis-2026.pdf') }}"
                                target="_blank">
                                <div style="height: 100px">
                    ...
                    <div class="col-lg-4 mb-4">
                        <div class="card text-center pt-4">
                            <a href="{{ asset('pdf/Estudiantes-matriculados-postulantes-ingresantes-egresados-2.pdf') }}"
                                target="_blank">
                                <div style="height: 100px">
                        ...
                        <table class="fid-modal-table">
                            ...
                            <tbody>
                                ...
                                <tr class="fid-modal-row--closed">
                                    <td data-label="Programa de Estudios">
                                        <a href="{{ route('primaria') }}" class="fid-modal-link fid-modal-link--muted"
                                            target="_blank">
                                            Educación Primaria
                                            <i class="fa-solid fa-arrow-right" aria-hidden="true"></i>
                                        </a>

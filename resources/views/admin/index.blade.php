...
@section('contenido')
    <div class="container-fluid py-3">
        @role('admin')
            ...
            <div class="d-flex flex-wrap align-items-center justify-content-between mb-4" style="gap:.75rem;">
                <div>
                    <h4 class="mb-0 font-weight-bold" style="color:#1e293b;">
                        <i class="fas fa-users-cog mr-2" style="color:#4e73df;"></i>Panel de Administración
                    </h4>
                    <small class="text-muted">Gestión de usuarios: alumnos FID, PPD, docentes, tutores y administradores</small>
                </div>
                <a href="{{ route('registerAdmin') }}" class="btn btn-sm btn-primary shadow-sm"
                    style="border-radius:.5rem; font-weight:600;">
            ...
            <div class="row mb-4">
                ...
                <div class="col-xl-2 col-md-4 col-6 mb-3">
                    <div class="card shadow-sm adm-stat-card h-100" style="border-left:4px solid #10b981;">
                        <div class="card-body py-2 px-3">
                            <div class="d-flex justify-content-between align-items-center">
                                <div>
                                    <div class="text-xs font-weight-bold text-uppercase mb-1" style="color:#10b981;">Tutores
                                    </div>
                                    <div class="h5 mb-0 font-weight-bold text-gray-800">{{ $conteoTutores }}</div>
                                </div>
                                ...
                                <tr class="alumno-row {{ $admin->beca == 1 ? 'becado' : '' }}">
                                    <td>
                                        <div class="d-flex align-items-center" style="gap:.75rem;">
                                            @if ($admin->foto)
                                                <img src="{{ asset('img/estudiantes/' . $admin->foto) }}" alt=""
                                                    class="adm-avatar">
                                            @else
                        ...
                        @foreach ($admins as $admin)
                            @if ($admin->hasRole('alumnoB'))
                                <tr class="alumno-row">
                                    ...
                                    <td style="white-space:nowrap;">
                                        <a href="{{ route('adminEdit', ['id' => $admin->id]) }}"
                                            class="adm-btn adm-btn-edit"><i class="fa fa-pen"></i></a>
                                        <a onclick="confirmarEliminacion('{{ route('adminDestroy', ['id' => $admin->id]) }}')"
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="#" class="adm-btn adm-btn-del ml-1" data-toggle="modal"
                                            ...
                                            data-href="{{ route('adminDestroy', ['id' => $admin->id]) }}"><i
                        ...
                        @foreach ($admins as $admin)
                            @if ($admin->hasRole('docente'))
                                ...
                                <tr>
                                    ...
                                    <td style="white-space:nowrap;">
                                        <a href="{{ route('adminEdit', ['id' => $admin->id]) }}"
                                            class="adm-btn adm-btn-edit"><i class="fa fa-edit"></i></a>
                                        <a href="#" class="adm-btn adm-btn-del ml-1" data-toggle="modal"
                                            data-target="#confirmDeleteModal"
                                            data-href="{{ route('adminDestroy', ['id' => $admin->id]) }}"><i
                                                class="fa fa-trash"></i></a>
                                ...
                                <tr>
                                    ...
                                    <td style="white-space:nowrap;">
                                        ...
                                        <a href="{{ route('admin.tutor.ciclos', $admin->id) }}"
                                            class="adm-btn adm-btn-ciclos ml-1" title="Asignar ciclos"><i
                                ...
                                <tr class="alumno-row">
                                    <td>
                                        <div class="d-flex align-items-center" style="gap:.75rem;">
                                            ...
                                            <div>
                                                <div class="adm-uname">{{ $admin->apellidos }}, {{ $admin->name }}</div>
                                                <div class="adm-umeta"><i
                                                        class="fas fa-envelope fa-xs mr-1"></i>{{ $admin->email }}</div>
                                                <div class="adm-umeta">
                                                    {{ optional($admin->programa)->nombre ?? 'N/A' }}
                                                    &nbsp;·&nbsp; Ciclo {{ optional($admin->ciclo)->nombre ?? 'N/A' }}
                                                    <span
    ...
    <div class="modal fade" id="confirmDeleteModal" tabindex="-1" role="dialog">
        <div class="modal-dialog" role="document">
            <div class="modal-content border-0 shadow">
                ...
                <div class="modal-body">¿Estás seguro de que deseas eliminar este usuario? Esta acción no se puede
                    deshacer.</div>
    ...
    <script>
        ...
        var allTables = ['admins-table', 'alumnos-table', 'alumnosppd', 'adminsB-table', 'docentes-table',
            'inhabilitado-table', 'tutores-table'
        ];
        var tabMap = {
            admins: {
                table: 'admins-table',
            ...
            docentes: {
                table: 'docentes-table',
                btn: 'btn-docentes'
            },
            inhabilitados: {
                table: 'inhabilitado-table',
                btn: 'btn-inhabilitados'
            },
            alumnos: {
                table: 'alumnos-table',
                btn: 'btn-alumnos'

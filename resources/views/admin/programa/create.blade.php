    ...
    <div class="pg-hero">
        <div class="d-flex align-items-center justify-content-between flex-wrap"
            ...
            <div>
                ...
                <h4><i class="fas fa-plus-circle mr-2"></i>Crear Programa</h4>
                <p class="pg-hero-sub">Registra un nuevo programa de estudios (FID o PPD)</p>
            </div>
            ...
            <form method="POST" action="{{ route('programa.store') }}">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" id="nombre" name="nombre"
                           ...
                           value="{{ old('nombre') }}"
                           placeholder="Ej: Educación Inicial — FID"
                           required autofocus>
                    @error('nombre')

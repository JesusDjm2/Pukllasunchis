...
<div class="container-fluid">
    <div class="d-sm-flex align-items-center justify-content-between mb-4 pt-3">
        <div>
            <h4 class="mb-0 font-weight-bold" style="color:#1e293b;"><i class="fas fa-qrcode mr-2" style="color:#4e73df;"></i>Nuevo Mink'arikuy</h4>
            <small class="text-muted">Crea un nuevo registro de asistencia con código QR</small>
        </div>

    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4 pb-2 pt-4"
        ...
        <div>
            <h5 class="mb-0 font-weight-bold text-primary">
                <i class="fa fa-exclamation-triangle mr-2 text-warning"></i> Todas las Incidencias
            </h5>
            <small class="text-muted">Registro completo de incidencias de todos los docentes</small>
        </div>
                ...
                <tbody>
                    @foreach ($incidencias as $inc)
                        <tr>
                            ...
                            <td>
                                @if ($inc->docente)
                                    <a href="{{ route('admin.docente.incidencias', $inc->docente->id) }}" class="text-dark font-weight-bold">
                                        {{ $inc->docente->nombre }}
                                    </a>

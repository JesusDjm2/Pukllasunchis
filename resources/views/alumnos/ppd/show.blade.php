                ...
                <table class="table table-bordered bg-white table-striped">
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td colspan="3">
                                {{-- @if ($alumno->ciclo && $alumno->ciclo->cursos->isNotEmpty())
                                ...
                                @else
                                    <em>Sin cursos</em>
                                @endif --}}
                                @if ($alumno->programa && $alumno->programa->ciclos->isNotEmpty())
                                    @foreach ($alumno->programa->ciclos as $ciclo)
                                        <h6 class="mt-3">
                                            {{ $ciclo->nombre }}:
                                        </h6>
                                        ...
                                        @else
                                            <em>No hay cursos en este ciclo</em>
                                        @endif
                                    @endforeach
                                @else
                                    <em>Este programa no tiene ciclos registrados</em>
                                @endif
                            </td>
                        </tr>

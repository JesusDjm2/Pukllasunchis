<div class="row">
    <div class="form-group col-lg-4 mb-2">
        ...
        <input type="text" class="form-control form-control-sm @error('colegio') is-invalid @enderror" id="colegio"
            name="colegio" value="{{ old('colegio', $postulante->colegio) }}" required>
        @error('colegio')
    ...
    <div class="form-group col-lg-4 mb-2">
        ...
        <input type="number" class="form-control form-control-sm @error('codigo_colegio') is-invalid @enderror"
            id="codigo_colegio" name="codigo_colegio" value="{{ old('codigo_colegio', $postulante->codigo_colegio) }}"
            required>
    ...
    <div class="form-group col-lg-4 mb-2">
        ...
        <select class="form-control form-control-sm @error('gestion_colegio') is-invalid @enderror" id="gestion_colegio"
            name="gestion_colegio" required>
...
<div class="row">
    ...
    <div class="form-group col-lg-4 mb-2">
        ...
        <input type="text" class="form-control form-control-sm @error('distrito_colegio') is-invalid @enderror"
            id="distrito_colegio" name="distrito_colegio"
    ...
    <div class="form-group col-lg-4 mb-2">
        ...
        <input type="text" class="form-control form-control-sm @error('provincia_colegio') is-invalid @enderror"
            id="provincia_colegio" name="provincia_colegio"
...
<div class="row">
    <div class="form-group col-lg-4 mb-2">
        ...
        <input type="text" class="form-control form-control-sm @error('departamento_colegio') is-invalid @enderror"
            id="departamento_colegio" name="departamento_colegio"
...
<div class="row">
    <div class="form-group col-lg-6 mb-2">
        ...
        <input type="text" class="form-control form-control-sm @error('lengua_1') is-invalid @enderror"
            id="lengua_1" name="lengua_1" value="{{ old('lengua_1', $postulante->lengua_1) }}" required>
        @error('lengua_1')
            <div class="invalid-feedback">{{ $message }}</div>
        @enderror
    </div>
    <div class="form-group col-lg-6 mb-2">
        ...
        <input type="text" class="form-control form-control-sm @error('lengua_2') is-invalid @enderror"
            id="lengua_2" name="lengua_2" value="{{ old('lengua_2', $postulante->lengua_2) }}">
        @error('lengua_2')
            <div class="invalid-feedback">{{ $message }}</div>
        @enderror
    </div>
...
<div class="row">
    <div class="form-group col-lg-4 mb-2">
        ...
        <select class="form-control form-control-sm @error('estado_civil') is-invalid @enderror" id="estado_civil" name="estado_civil" required>
            <option value="" disabled selected>Seleccione una opción</option>
            <option value="soltero" {{ old('estado_civil', $postulante->estado_civil) == 'soltero' ? 'selected' : '' }}>Soltero</option>
            <option value="casado" {{ old('estado_civil', $postulante->estado_civil) == 'casado' ? 'selected' : '' }}>Casado</option>
            <option value="divorciado" {{ old('estado_civil', $postulante->estado_civil) == 'divorciado' ? 'selected' : '' }}>Divorciado</option>
            <option value="viudo" {{ old('estado_civil', $postulante->estado_civil) == 'viudo' ? 'selected' : '' }}>Viudo</option>
        </select>
        @error('estado_civil')
            <div class="invalid-feedback">{{ $message }}</div>
        @enderror
    ...
    <div class="form-group col-lg-4 mb-2">
        ...
        <input type="number" class="form-control form-control-sm @error('num_hijos') is-invalid @enderror" id="num_hijos"
            name="num_hijos" value="{{ old('num_hijos', $postulante->num_hijos) }}">
        @error('num_hijos')
            <div class="invalid-feedback">{{ $message }}</div>
        @enderror
    </div>
...
<div class="row">
    <div class="form-group col-lg-6 mb-2">
        ...
        <input type="text" class="form-control form-control-sm @error('donde_trabajas') is-invalid @enderror" id="donde_trabajas"
            name="donde_trabajas" value="{{ old('donde_trabajas', $postulante->donde_trabajas) }}">
    ...
    <div class="form-group col-lg-6 mb-2">
        ...
        <input type="text" class="form-control form-control-sm @error('cargo_trabajas') is-invalid @enderror" id="cargo_trabajas"
            name="cargo_trabajas" value="{{ old('cargo_trabajas', $postulante->cargo_trabajas) }}">
...
<div class="row">
    <div class="form-group col-lg-12 mb-2">
        <label for="describe_eespp">Describe por qué elegiste el EESPP:</label>
        <textarea class="form-control form-control-sm @error('describe_eespp') is-invalid @enderror" id="describe_eespp"
            name="describe_eespp" rows="3">{{ old('describe_eespp', $postulante->describe_eespp) }}</textarea>

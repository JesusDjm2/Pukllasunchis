    ...
    <div class="container-fluid bg-white pt-2">
        ...
        <div class="mb-5">
            <h4 class="text-dark font-weight-bold mb-3">
                <i class="fas fa-flask text-primary mr-2"></i> Formatos de Investigación (TI)
            </h4>
            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-6 text-center mb-3">
                    <div class="card">
                        ...
                        <a href="{{ asset('pdf/CaratulaTI-2025 PPD.docx') }}"
            ...
            <div class="row">
                ...
                <div class="col-lg-3 mb-3 col-6 text-center">
                    <div class="card">
                        ...
                        <a href="{{ asset('pdf/CaratulaTesis-2025-PPD.docx') }}"
                            class="btn btn-primary btn-sm mt-2">Descargar</a>
                    </div>
                </div>
                <div class="col-lg-3 mb-3 col-6 text-center">

...
@section('contenido')
    ...
    <section class="fondoClaro">
        <div class="container">
            ...
            {{-- CTA: Información Institucional --}}
            <div class="row mt-5 mb-3">
                <div class="col-12">
                    <style>
                        .puk-info-cta {
                            position: relative;
                            background: linear-gradient(135deg, #0d2137 0%, #1a4a6e 45%, #0e2d44 100%);
                        ...
                        .puk-info-cta::after {
                            ...
                            height: 4px;
                            background: linear-gradient(90deg, #c9873f, #e8b84b, #c9873f);
                        ...
                        .puk-info-btn {
                            ...
                            box-shadow: 0 6px 24px rgba(201,135,63,.45);
                        ...
                        .puk-info-btn:hover {
                            ...
                            box-shadow: 0 14px 36px rgba(201,135,63,.55);
                            filter: brightness(1.07);
                        }
                        .puk-info-btn:hover::before { left: 160%; }
                        .puk-info-btn svg { transition: transform .2s ease; }
                        .puk-info-btn:hover svg { transform: translateX(4px); }
                    </style>
                    <div class="puk-info-cta">
                        <span class="puk-info-eyebrow">Transparencia institucional</span>
                        <h3 class="puk-info-cta-title">Información Institucional</h3>
                        <p class="puk-info-cta-desc">
                            Documentos oficiales, normativas, estadísticas y recursos de gestión de nuestra institución al alcance de todos.
                        </p>
                        <a href="{{ route('informacion') }}" class="puk-info-btn">
                            Conocer más
    ...
    {{-- GSAP: animación de entrada solo para el CTA de Información Institucional --}}
    <script>
    (function () {
        var cta = document.querySelector('.puk-info-cta');
        if (!cta || typeof gsap === 'undefined' || typeof ScrollTrigger === 'undefined') return;

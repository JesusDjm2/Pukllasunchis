...
@section('title', '405 - Acción no disponible')
@section('code', '405')

@section('message')
    <div class="text-center">
        <h2 class="fw-semibold mb-4">Esa acción no está disponible aquí</h2>

        <p class="text-light fs-5 mb-4">
            Ups... parece que esta pantalla quedó desactualizada (por ejemplo, si la dejaste abierta
            en una pestaña por mucho tiempo). Vuelve atrás, recarga la página e inténtalo nuevamente.
        </p>
